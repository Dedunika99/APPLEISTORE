...
public class Sales extends javax.swing.JFrame {
 ...
 public void Sales() {
    ...
    try {
        ...
        while (rs.next()) {
            ...
            if (qty > currentQty) {
                ...
                String updateQuery = "UPDATE product_details SET quantity = ? WHERE product_id = ?";
                pst2 = db.con.prepareStatement(updateQuery);

                int updatedQty = currentQty - qty;
                pst2.setInt(1, updatedQty);
                pst2.setString(2, ID);
                pst2.executeUpdate();
    ...
    private void add3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add3ActionPerformed
        try {
            int total=Integer.parseInt(totalCost.getText());
            int pay=Integer.parseInt(payment.getText());
            ...
            jTextArea1.setText("------------------------------------------------------------------------------------------------------------------\n");
            jTextArea1.append("                                                          Apple Store                                               \n");
            jTextArea1.append("------------------------------------------------------------------------------------------------------------------\n");
            jTextArea1.append("                                                      Kurunegala Rd,Kandy                                         \n");
            jTextArea1.append("                                                       TP : 066 225 6898                                               \n\n");
            ...
            jTextArea1.append( "Pid                     Name                        Price                         Qty                     Amount\n\n");
            
            
            int rowCount=purchaseTable.getRowCount();
            for(int i=0;i<rowCount;i++){
                String txtId=purchaseTable.getValueAt(i, 0).toString();
                String txtName=purchaseTable.getValueAt(i, 1).toString();
                String txtPrice=purchaseTable.getValueAt(i, 2).toString();
                String txtQty=purchaseTable.getValueAt(i, 2).toString();
                String txtAmount=purchaseTable.getValueAt(i, 4).toString();
                
                jTextArea1.append( txtId+"                   ");
                jTextArea1.append(txtName+"                  ");
                jTextArea1.append(txtPrice+"                 ");
                jTextArea1.append(txtQty+"                   ");
                jTextArea1.append(txtAmount+"              \n");
                
                jTextArea1.append("\n");
                
            }
            jTextArea1.append("------------------------------------------------------------------------------------------------------------------\n");
            jTextArea1.append("Total: " + totalCost.getText() + "\n");
            
            // Assuming you have a payment amount (replace 0.0 with the actual payment)
            
            jTextArea1.append("Payment: " + payment.getText() + "\n");
            
            // Calculate and display the balance
            
            jTextArea1.append("Balance: " + totalCost.getText() + "\n");
            jTextArea1.print();
